% Main class to prepare and hold the reconstruction data 
...
classdef Data
% Description: Main class to prepare and hold the reconstruction data 
    ...
    methods
        function [self,varargin] = Data(type, varargin)
            % Constructor  
            switch type 
                case 'artificial'
                    [self,varargin]  = get_inputs_artificial(self, varargin{:}) ; 
                case 'real'
                    [self,varargin]  = get_inputs_real_new(self, varargin{:}) ; 
            end
        end
        show_data(self, pos)
        self = update(self, varargin); %  update reconstruction inputs
        [vargout]=show(self, varargin)
    end
end
